...
public class MarcoGridLayout extends JFrame implements ActionListener
{
 ...
 private final Container contenedor; // contenedor del marco
 private final GridLayout cuadricula1; // primer objeto GridLayout
 private final GridLayout cuadricula2; // segundo objeto GridLayout

 // constructor sin argumentos
 public MarcoGridLayout()
 {
     super("Demostracion de GridLayout:Ortiz Ortega-Torres Buscaglia");
